...
function renderHeroBanner(headline, subline, ctaText, ctaHref) {
  return [
    ...
    '      <img',
    '        src="https://images.unsplash.com/photo-1571008887538-b36bb32f4571?auto=format&fit=crop&w=720&q=80"',
    '        alt="Athlete running at speed"',
    '        onerror="this.onerror=null;this.src=\'https://placehold.co/720x540/16304e/ffffff?text=GearUp+Velocity\'"',
    '      />',
    '    </div>',
    '  </div>',
    '</div>',
